    ...
    <header>
        ...
        <div class="navbar">
            ...
            <nav class=" green darken-3" id="myHeader">
                <div class="nav-wrapper">
                    <a class="hide" id="logo"><img style="padding: 10px;" src="./images/Escudo.png" alt="sannicolas" width=auto height=100%></a>
                    <a href="#" data-target="menu-responsive" class="sidenav-trigger right">
                        <i class="material-icons">menu</i>
                    </a>
                    <!--lista de menus de navegación-->
                    <ul class="right hide-on-med-and-down">
                        <li class="<?php if ($menu == "Inicio") {
                                        echo "active";
                        ...
                        <li class="<?php if ($menu == "TOVARO") {
                                        echo "active";
                                    } ?>"><a href="live.php" target="_blank">Radio</a></li>
                        <li class="<?php if ($menu == "Especialidades") {
                                        echo "active";
            ...
            <ul id="institucion" class="dropdown-content white-text" style="background-color: transparent;">
                <li></li>
                <li class="li"><a href="nosotros.php">Reseña Histórica</a></li>
                <li class="li"><a href="simbolos.php">Simbolos Institucionales</a></li>
                <li class="li"><a href="sedes.php">Sedes</a></li>
                <li class="li"><a href="docentes.php">Docentes</a></li>
                <li class="li"><a href="gobierno-escolar.php">Gobierno Escolar</a></li>
                <li class="li"><a href="proyectos.php">Proyectos</a></li>
                <li class="li"><a href="#" target="_blank">Psicoorientación</a></li>
            </ul>
      ...
      <!-- Submenus responsives -->
            ...
            <ul id="institucion-responsive" class="dropdown-content" style="background-color: transparent;">
                ...
                <li class="li"><a href="https://tovaro2020.wixsite.com/psicoorientacion" class="white-text" target="_blank">Psicoorientación</a></li>
            </ul>

            <!-- Lista de especialidades -->
            <ul id="esp-responsive" class="dropdown-conten" style="background-color: transparent;">
               <!--  <li></li>
                <li class="li"><a href="redes.php" class="white-text">Redes y sistemas</a></li>
                <li class="li"><a href="salud.php" class="white-text">Salud</a></li>
                <li class="li"><a href="turismo.php" class="white-text">Turismo</a></li>
            ...
            <ul class="sidenav" id="menu-responsive">
                ...
                <li class="<?php if ($menu == "Institución") {
                                echo "active";
                            } ?>"><a href="#" class="dropdown-trigger" data-target="institucion-responsive">
                        Institución
                        <i class="material-icons right">arrow_drop_down</i>
                    </a>
                </li>
                ...
                <li class="<?php if ($menu == "Especialidades") {
                                echo "active";
                            } ?>"><a href="#" class="dropdown-trigger" data-target="esp-responsive">
                        Especialidades
                        <i class="material-icons right">arrow_drop_down</i>
                    </a>
                </li>
