...
<div class="parallax-container">
   <div class="parallax"><img src="./images/e-Salud/1.jpg" ></div>
...
<!--------------------- Vision ------------------------------>
<div class="parallax-container">
   <div class="parallax"><img src="./images/e-Salud/2.jpg" ></div>
...
<!--------------------- Objetivos ------------------------------>
<div class="parallax-container">
   <div class="parallax"><img src="./images/e-Salud/3.jpg" ></div>
   ...
   <div class="row">
       ...
       <h2 class="center green-text text-darken-4">Objetivos</h2>
          <ul>
              ...
              <li>✔ Permitir una formación por Ciclos Propedéuticos, desde la consolidación y estructuración de un programa que ofrece el ciclo Técnico Profesional en servicios administrativos de salud, para continuar con el ciclo de Tecnólogo en gestión administrativa de servicios de salud y culminar con el programa Profesional de Administración de Servicios de Salud. </li>
              <li>✔ Desarrollar en los estudiantes las competencias tanto generales como específicas necesarias para alcanzar los objetivos de formación. </li>
          </ul>
       </div>
   </div>
</div>
...
<!--------------------- Perfil Profesional ------------------------------>
<div class="parallax-container">
   <div class="parallax"><img src="./images/e-Salud/4.jpg" ></div>
   ...
   <div class="row">
       ...
       <div class="col s12 m6 columnas opacity">
           ...
           <ul>
              ...
              <li>✔ Auxiliar de archivo y registro de historias clínicas. </li>
              <li>✔ Auxiliar de ingreso y recaudo. </li>
          </ul>
       </div>
   </div>
</div>
