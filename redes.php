...
<!--------------------- Mision ------------------------------>
   ...
   <div class="parallax"><img src="./images/e-Redes/1.jpg" ></div>
...
<!--------------------- Vision ------------------------------>
<div class="parallax-container">
   <div class="parallax"><img src="./images/e-Redes/2.jpg" ></div>
   
   <div class="row">
       <br>
       <!--Empuja la col 2 hacia la derecha-->
...
<!--------------------- Objetivos ------------------------------>
<div class="parallax-container">
   <div class="parallax"><img src="./images/e-Redes/3.jpg" ></div>
   ...
   <div class="row">
       ...
       <h2 class="center green-text text-darken-4">Objetivos</h2>
          <ul>
              ...
              <li>✔ Generar espacios de investigación y reflexión entorno a la aplicación de procesos telemáticos y de incorporación de Tecnologías de la Información y las Comunicaciones en el país, así se permitirá el fortalecimiento y crecimiento de este sector en beneficio de la empresa y la sociedad, obteniendo como resultado final un mejoramiento de la calidad de vida de los colombianos. </li>
              <li>✔ Permitir una formación por Ciclos Propedéuticos, desde la consolidación y estructuración de un programa que ofrece el ciclo Técnico Profesional en instalación y mantenimiento de redes y computadores, para continuar con el ciclo de Tecnólogo en Telemática. </li>
          </ul>
       </div>
   </div>
</div>
...
<!--------------------- Perfil Profesional ------------------------------>
<div class="parallax-container">
   <div class="parallax"><img src="./images/e-Redes/4.jpg" ></div>
   ...
   <div class="row">
       ...
       <div class="col s12 m6 columnas opacity">
           ...
           <ul>
              <li>✔ Instalar, configurar y realiza el mantenimiento de soluciones de conectividad a través de redes de computadores cableadas e inalámbricas, sobre las cuales se de transmisión de video, voz y datos; de esta manera se cubre la demanda que actualmente tienen las telecomunicaciones en el país de un perfil técnico para la parte de instalación y mantenimiento en el sector de las redes de computadores LAN y la telemática. </li>
              <li>✔ Realizar la configuración y el mantenimiento de los componentes de computadores de escritorio y portátiles. Integrando sus valores éticos y profesionales en pro de la evolución organizacional de las empresas donde se desempeñe. </li>
              <li>✔ Estructurar y organizar su propio negocio acorde con sus saberes profesionales. </li>
          </ul>
       </div>
   </div>
</div>
